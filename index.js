...
const countDislike1= document.getElementById("countLikes1")
const btnDislike2= document.getElementById("btnLike2")
const countDislike2= document.getElementById("countLikes2")
...
function clickLike2() {
  let totalLiike2= parseInt(countLikes2.value) + 1
  countLike2.textContent = totalLikes2.toString()
}
...
function clickDislike2() {
  ...
  countLikes2.textContent = totalDislike2.toString()
}
